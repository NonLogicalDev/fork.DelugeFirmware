...
namespace menu_midi = deluge::gui::menu_item::midi;
...
PLACE_SDRAM_BSS menu_midi::sound::OutputMidiChannel outputMidiChannelMenu{STRING_FOR_CHANNEL, STRING_FOR_CHANNEL};
PLACE_SDRAM_BSS menu_midi::sound::OutputMidiNoteForDrum outputMidiNoteForDrumMenu{STRING_FOR_NOTE, STRING_FOR_NOTE};
PLACE_SDRAM_BSS Submenu outputMidiSubmenu{STRING_FOR_MIDI, {&outputMidiChannelMenu, &outputMidiNoteForDrumMenu}};

// MIDIInstrument menu ----------------------------------------------------------------------
PLACE_SDRAM_BSS menu_midi::device_definition::Linked midiDeviceLinkedMenu{
    STRING_FOR_MIDI_DEVICE_DEFINITION_LINKED,
    STRING_FOR_MIDI_DEVICE_DEFINITION_LINKED,
};
PLACE_SDRAM_BSS menu_midi::device_definition::HideUnlabeled hideUnlabeledCCMenu{
    STRING_FOR_MIDI_DEVICE_DEFINITION_HIDE,
    STRING_FOR_MIDI_DEVICE_DEFINITION_HIDE,
};

PLACE_SDRAM_BSS menu_midi::device_definition::DeviceDefinitionSubmenu midiDeviceDefinitionMenu{
...
PLACE_SDRAM_BSS menu_midi::Bank midiBankMenu{STRING_FOR_BANK, STRING_FOR_MIDI_BANK};
PLACE_SDRAM_BSS menu_midi::Sub midiSubMenu{STRING_FOR_SUB_BANK_SHORT, STRING_FOR_MIDI_SUB_BANK};
PLACE_SDRAM_BSS menu_midi::PGM midiPGMMenu{STRING_FOR_PGM, STRING_FOR_MIDI_PGM_NUMB_MENU_TITLE};
PLACE_SDRAM_BSS menu_midi::MPEYToModWheel mpeyToModWheelMenu{STRING_FOR_Y_AXIS_CONVERSION,
                                                             STRING_FOR_Y_AXIS_CONVERSION};
PLACE_SDRAM_BSS cv::DualCVSelection cv2SourceMenu{STRING_FOR_CV2_SOURCE};
PLACE_SDRAM_BSS menu_midi::AftertouchToMono midiAftertouchCollapseMenu{STRING_FOR_PATCH_SOURCE_AFTERTOUCH,
                                                                       STRING_FOR_PATCH_SOURCE_AFTERTOUCH};
PLACE_SDRAM_BSS menu_midi::MPEToMono midiMPECollapseMenu{STRING_FOR_MPE, STRING_FOR_MPE};
...
// MIDI Takeover
PLACE_SDRAM_BSS menu_midi::Takeover midiTakeoverMenu{STRING_FOR_TAKEOVER};

// MIDI Follow
PLACE_SDRAM_BSS menu_midi::FollowChannel midiFollowChannelAMenu{STRING_FOR_FOLLOW_CHANNEL_A,
                                                                STRING_FOR_FOLLOW_CHANNEL_A, MIDIFollowChannelType::A};
PLACE_SDRAM_BSS menu_midi::FollowChannel midiFollowChannelBMenu{STRING_FOR_FOLLOW_CHANNEL_B,
                                                                STRING_FOR_FOLLOW_CHANNEL_B, MIDIFollowChannelType::B};
PLACE_SDRAM_BSS menu_midi::FollowChannel midiFollowChannelCMenu{STRING_FOR_FOLLOW_CHANNEL_C,
                                                                STRING_FOR_FOLLOW_CHANNEL_C, MIDIFollowChannelType::C};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack1Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track1, 1};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack2Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track2, 2};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack3Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track3, 3};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack4Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track4, 4};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack5Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track5, 5};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack6Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track6, 6};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack7Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track7, 7};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack8Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track8, 8};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack9Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track9, 9};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack10Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track10, 10};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack11Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track11, 11};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack12Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track12, 12};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack13Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track13, 13};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack14Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track14, 14};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack15Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track15, 15};
PLACE_SDRAM_BSS menu_midi::FollowChannelTrack midiFollowChannelTrack16Menu{
    STRING_FOR_FOLLOW_CHANNEL_TRACK, STRING_FOR_FOLLOW_CHANNEL_TRACK, MIDIFollowChannelType::Track16, 16};
PLACE_SDRAM_BSS menu_midi::FollowKitRootNote midiFollowKitRootNoteMenu{STRING_FOR_FOLLOW_KIT_ROOT_NOTE};
...
PLACE_SDRAM_BSS menu_midi::FollowFeedbackChannelType midiFollowFeedbackChannelMenu{STRING_FOR_CHANNEL};
PLACE_SDRAM_BSS menu_midi::FollowFeedbackAutomation midiFollowFeedbackAutomationMenu{
...
PLACE_SDRAM_BSS menu_midi::Transpose midiTransposeMenu{STRING_FOR_TRANSPOSE};
...
PLACE_SDRAM_BSS menu_midi::Command playbackRestartMidiCommand{STRING_FOR_RESTART, GlobalMIDICommand::PLAYBACK_RESTART};
PLACE_SDRAM_BSS menu_midi::Command playMidiCommand{STRING_FOR_PLAY, GlobalMIDICommand::PLAY};
PLACE_SDRAM_BSS menu_midi::Command recordMidiCommand{STRING_FOR_RECORD, GlobalMIDICommand::RECORD};
PLACE_SDRAM_BSS menu_midi::Command tapMidiCommand{STRING_FOR_TAP_TEMPO, GlobalMIDICommand::TAP};
PLACE_SDRAM_BSS menu_midi::Command undoMidiCommand{STRING_FOR_UNDO, GlobalMIDICommand::UNDO};
PLACE_SDRAM_BSS menu_midi::Command redoMidiCommand{STRING_FOR_REDO, GlobalMIDICommand::REDO};
PLACE_SDRAM_BSS menu_midi::Command loopMidiCommand{STRING_FOR_LOOP, GlobalMIDICommand::LOOP};
PLACE_SDRAM_BSS menu_midi::Command loopContinuousLayeringMidiCommand{STRING_FOR_LAYERING_LOOP,
                                                                     GlobalMIDICommand::LOOP_CONTINUOUS_LAYERING};
PLACE_SDRAM_BSS menu_midi::Command fillMidiCommand{STRING_FOR_FILL, GlobalMIDICommand::FILL};
PLACE_SDRAM_BSS menu_midi::Command transposeMidiCommand{STRING_FOR_TRANSPOSE, GlobalMIDICommand::TRANSPOSE};
PLACE_SDRAM_BSS menu_midi::Command nextSongMidiCommand{STRING_FOR_SONG_LOAD_NEXT, GlobalMIDICommand::NEXT_SONG};
PLACE_SDRAM_BSS menu_midi::Command shiftMidiCommand{STRING_FOR_SHIFT, GlobalMIDICommand::SHIFT};
...
PLACE_SDRAM_BSS menu_midi::DefaultVelocityToLevel defaultVelocityToLevelMenu{STRING_FOR_VELOCITY};
PLACE_SDRAM_BSS menu_midi::DeviceSendClock device_send_clock_menu{STRING_FOR_CLOCK_OUT};
PLACE_SDRAM_BSS menu_midi::DeviceReceiveClock device_receive_clock_menu{STRING_FOR_CLOCK_IN};
PLACE_SDRAM_BSS menu_midi::DeviceIsRelative device_is_relative_menu{STRING_FOR_IS_RELATIVE};
PLACE_SDRAM_BSS menu_midi::DeviceSendThru device_send_thru_menu{STRING_FOR_MIDI_THRU};
PLACE_SDRAM_BSS menu_midi::Device midiDeviceMenu{
    EMPTY_STRING,
    {
...
// MIDI clock menu
PLACE_SDRAM_BSS menu_midi::SendClock send_clock_menu{STRING_FOR_OUTPUT, STRING_FOR_MIDI_CLOCK_OUT,
                                                     playbackHandler.midiOutClockEnabled};
PLACE_SDRAM_BSS menu_midi::ReceiveClock receive_clock_menu{STRING_FOR_INPUT, STRING_FOR_MIDI_CLOCK_IN,
...
// Midi devices menu
PLACE_SDRAM_BSS menu_midi::Devices menu_midi::devicesMenu{STRING_FOR_DEVICES, STRING_FOR_MIDI_DEVICES};
...
PLACE_SDRAM_BSS menu_item::midi::external_step::Mode externalStepModeMenu{STRING_FOR_MODE};
PLACE_SDRAM_BSS menu_item::midi::external_step::Size externalStepSizeMenu{STRING_FOR_EXTERNAL_STEP_SIZE};
PLACE_SDRAM_BSS menu_item::midi::external_step::Input externalStepInputMenu{
    STRING_FOR_EXTERNAL_STEP_INPUT, menu_item::midi::external_step::InputRole::STEP};
PLACE_SDRAM_BSS menu_item::midi::external_step::Input externalResetInputMenu{
    STRING_FOR_EXTERNAL_RESET_INPUT, menu_item::midi::external_step::InputRole::RESET};
PLACE_SDRAM_BSS menu_item::midi::external_step::Status externalStepStatusMenu{STRING_FOR_EXTERNAL_STEP_STATUS};
PLACE_SDRAM_BSS menu_item::midi::external_step::Clock externalStepClockMenu{
    STRING_FOR_CLOCK,
    {
        &externalStepModeMenu,
        &externalStepSizeMenu,
        &externalStepInputMenu,
        &externalResetInputMenu,
        &externalStepStatusMenu,
    },
};
