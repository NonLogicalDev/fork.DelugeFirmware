...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_MANUAL_SLICE_NEEDS_TOP_EMPTY_KIT_PAD, "EMPTY"},
        ...
        {STRING_FOR_KIT_ROW_COPIED, "COPY"},
        {STRING_FOR_KIT_SOUND_COPIED, "SOUND"},
        {STRING_FOR_NO_KIT_ROW_TO_PASTE, "NONE"},
        {STRING_FOR_KIT_ROW_TARGET_UNAVAILABLE, "CANT"},
        {STRING_FOR_KIT_ROW_PASTED, "PASTE"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_MIDI_SUSTAIN_PEDAL, "SUST"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_EXTERNAL_STEP_MIDI_CLIPS, "XSTP"},
        {STRING_FOR_EXTERNAL_STEP, "XSTP"},
        {STRING_FOR_EXTERNAL_STEP_SIZE, "SIZE"},
        {STRING_FOR_EXTERNAL_STEP_INPUT, "STEP"},
        {STRING_FOR_EXTERNAL_RESET_INPUT, "RSET"},
        {STRING_FOR_EXTERNAL_STEP_STATUS, "STAT"},
        {STRING_FOR_EXTERNAL_STEP_WAITING, "WAIT"},
        {STRING_FOR_EXTERNAL_STEP_MISSING_INPUT, "MISS"},
        {STRING_FOR_EXTERNAL_STEP_CONFLICT, "CONF"},
        {STRING_FOR_EXTERNAL_STEP_UNASSIGNED, "NONE"},
        {STRING_FOR_EXTERNAL_STEP_UNSUPPORTED, "UNSP"},
        {STRING_FOR_EXTERNAL_STEP_READY, "RDY"},
    },
    &built_in::english,
};
} // namespace deluge::l10n::built_in
