...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_MANUAL_SLICE_NEEDS_TOP_EMPTY_KIT_PAD, "Manual slice needs top empty Kit pad"},
        ...
        {STRING_FOR_KIT_ROW_COPIED, "Kit row copied"},
        {STRING_FOR_KIT_SOUND_COPIED, "Kit sound copied"},
        {STRING_FOR_NO_KIT_ROW_TO_PASTE, "No Kit row to paste"},
        {STRING_FOR_KIT_ROW_TARGET_UNAVAILABLE, "Target must be empty or a Sound Drum"},
        {STRING_FOR_KIT_ROW_PASTED, "Kit row pasted"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_MIDI_SUSTAIN_PEDAL, "MIDI Sustain Pedal"},
